...
# 1. Include logic that omits sources if the information is not from the sources
# 2. Is adapted for streaming via JS
...
print('\nResponse5:\n')
response5 = get_response("What was my last question?", "123", "1")
print('\n')